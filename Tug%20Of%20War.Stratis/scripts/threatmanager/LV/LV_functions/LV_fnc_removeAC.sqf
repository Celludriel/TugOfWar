...
LV_deleteOnDestination = compile preprocessFile "scripts\threatmanager\LV\LV_functions\LV_fnc_deleteOnDestination.sqf";
LV_killAfterDelay = compile preprocessFile "scripts\threatmanager\LV\LV_functions\LV_fnc_killAfterDelay.sqf";
