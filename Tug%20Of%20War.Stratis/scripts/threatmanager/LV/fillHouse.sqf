...
if(isNil("LV_nearestBuilding"))then{LV_nearestBuilding = compile preprocessFile "scripts\threatmanager\LV\LV_functions\LV_fnc_nearestBuilding.sqf";};
...
while{_i2 < _rat}do{
	...
	if(_patrol)then{
        	switch (_pType) do {
            		case 1: {
                		_pFile = "scripts\threatmanager\LV\patrol-vF.sqf";
            		};
            		case 2: {
                		_pFile = "scripts\threatmanager\LV\patrol-vG.sqf";
            		};
        	};
